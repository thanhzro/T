...
echo "================================"
echo "Done."
bash _mk_test.sh "upper" "lib/basic/string.t" "str=s" "s=\"hello\""
bash _mk_test.sh "lower" "lib/basic/string.t" "str=s" "s=\"HELLO\""
bash _mk_test.sh "trim" "lib/basic/string.t" "str=s" "s=\"  hi  \""
bash _mk_test.sh "replace" "lib/basic/string.t" "str=s, old=world, new=T" "s=\"hello world\""
...
bash _mk_test.sh "join" "lib/basic/array.t" "arr=nums, sep=," "nums=[1,2,3]"
