...
linear_rows(r0=nrow_7_3_0, r1=nrow_7_3_1, r2=nrow_7_3_2, r3=nrow_7_3_3, bv=bv, x=xa) ~> final0
softmax(arr=final0) ~> prob0
argmax4(arr=prob0) ~> ans0
linear_rows(r0=nrow_7_3_0, r1=nrow_7_3_1, r2=nrow_7_3_2, r3=nrow_7_3_3, bv=bv, x=xb) ~> final1
softmax(arr=final1) ~> prob1
argmax4(arr=prob1) ~> ans1
linear_rows(r0=nrow_7_3_0, r1=nrow_7_3_1, r2=nrow_7_3_2, r3=nrow_7_3_3, bv=bv, x=xc) ~> final2
softmax(arr=final2) ~> prob2
argmax4(arr=prob2) ~> ans2
linear_rows(r0=nrow_7_3_0, r1=nrow_7_3_1, r2=nrow_7_3_2, r3=nrow_7_3_3, bv=bv, x=xd) ~> final3
