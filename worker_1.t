...
write_file_t(path="wr0_1.txt", content=wstr0) ~> ok0
join(arr=wr1, sep=",") ~> wstr1
write_file_t(path="wr1_1.txt", content=wstr1) ~> ok1
join(arr=wr2, sep=",") ~> wstr2
write_file_t(path="wr2_1.txt", content=wstr2) ~> ok2
join(arr=wr3, sep=",") ~> wstr3
write_file_t(path="wr3_1.txt", content=wstr3) ~> ok3
[T+]
show shall(ls)